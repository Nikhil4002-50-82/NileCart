...
const TwoColumnLayout = () => {
  ...
  const getAllData = async () => {
    try {
      const response = await axios.get("https://shopifyclone-xqn0.onrender.com/getAllProducts");
  ...
  return (
    <div className="px-6 md:px-20 mb-10 overflow-hidden">
      <div ref={wrapper} className="md:grid md:grid-cols-[2fr_7fr] md:gap-5 h-auto">
